...
def train(train_file_list, test_file_list, data_args, init_model_path):
    # 创建优化方法
    ...
    dev_reader = paddle.batch(
        data_provider.test(data_args, test_file_list),
        batch_size=cfg.TRAIN.BATCH_SIZE)
...
if __name__ == '__main__':
    ...
    # 开始训练
    train(train_file_list='../data/plate_number/trainval.txt',
          test_file_list='../data/plate_number/test.txt',
          data_args=data_args,
          # 预训练模型
